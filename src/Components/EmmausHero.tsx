  ...
  return <Container>
    ...
    <Text>
      ...
      transition={{delay : 0.8 , duration : 0.4}}>Emmaüs Châtellerault</motion.h1>
        ...
        initial ={{opacity : 0}}
      whileInView={{opacity : 1}}
      transition={{delay : 1 , duration : 0.4}}>Notre boutique en ligne vous permet de dénicher des objets farfelus, rares, ou plus courants mais tout aussi intéressants, comme si vous étiez dans l&pos;un des rayons d&apos;un de nos 4 lieux de vente.
